...
export default {
    ...
    methods: {
        ...
        async getLatesVersion() {
            const url = 'https://api.github.com/repos/sfccdevops/sfcc_developers_core/releases/latest';
            ...
            if (response && typeof response.data !== 'undefined') {
                ...
                if (hasNewVersion(process.env.PACKAGE_VERSION, latestVersion)) {
                    this.showMessage('info', `<strong>SFCC Developers Core</strong> Update Available ( <strong>${latestVersion}</strong> )`, () => {
